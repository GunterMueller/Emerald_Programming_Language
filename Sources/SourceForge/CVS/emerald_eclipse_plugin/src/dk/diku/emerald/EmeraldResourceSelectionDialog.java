 ...
 * </p>
 */
public class EmeraldResourceSelectionDialog extends SelectionDialog {
 ...
 */
public EmeraldResourceSelectionDialog(Shell parentShell, IAdaptable rootElement, String message) {
	super(parentShell);
