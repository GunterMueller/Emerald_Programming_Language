...
public interface IEmeraldHostListViewer {
	
	/**
	 * Update the view to reflect the fact that a host was added 
	 * to the host list
	 * 
	 * @param host
	 */
	...
	/**
	 * Update the view to reflect the fact that a host was removed 
	 * from the host list
	 * 
	 * @param host
	 */
	...
	/**
	 * Update the view to reflect the fact that one of the hosts
	 * was modified 
	 * 
	 * @param host
	 */
