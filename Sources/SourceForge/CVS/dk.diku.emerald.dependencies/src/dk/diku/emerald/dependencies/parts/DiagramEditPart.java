...
import dk.diku.emerald.dependencies.model.commands.DependencyFileCreateCommand;
import dk.diku.emerald.dependencies.model.commands.DependencyFileSetConstraintCommand;

/**
 * EditPart for the a EmeraldDependencyDiagram instance.
...
private EmeraldDependencyDiagram getCastedModel() {
	return (EmeraldDependencyDiagram) getModel();
}
...
public void propertyChange(PropertyChangeEvent evt) {
	...
	if (EmeraldDependencyDiagram.CHILD_ADDED_PROP.equals(prop)
			|| EmeraldDependencyDiagram.CHILD_REMOVED_PROP.equals(prop)) {
		refreshChildren();
	}
}
...
protected Command createChangeConstraintCommand(ChangeBoundsRequest request,
	...
	if (child instanceof DependencyFileEditPart && constraint instanceof Rectangle) {
		// return a command that can move and/or resize a DependencyFile
		return new DependencyFileSetConstraintCommand(
				(DependencyFile) child.getModel(), request, (Rectangle) constraint);
	}
...
protected Command getCreateCommand(CreateRequest request) {
	...
	if (childClass == EmeraldDependencyFile.class) {
		// return a command that can add a DependencyFile to a EmeraldDependencyDiagram 
		return new DependencyFileCreateCommand(DiagramEditPart.this.getCastedModel(), request);
	}
	return null;
}
