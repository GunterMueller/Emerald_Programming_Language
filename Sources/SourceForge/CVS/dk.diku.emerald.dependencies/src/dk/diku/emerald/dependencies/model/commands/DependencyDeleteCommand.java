 ...
 */
public class DependencyDeleteCommand extends Command {

/** Dependency instance to disconnect. */
private final Dependency connection;
 ...
 */ 
public DependencyDeleteCommand(Dependency conn) {
	if (conn == null) {
