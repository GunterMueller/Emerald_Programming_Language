 ...
 */
public class DependencyFileDeleteCommand extends Command {
/** DependencyFile to remove. */
private final DependencyFile child;
 ...
 * @param parent the EmeraldDependencyDiagram containing the child
 * @param child    the DependencyFile to remove
 * @throws IllegalArgumentException if any parameter is null
 */
public DependencyFileDeleteCommand(EmeraldDependencyDiagram parent, DependencyFile child) {
