 ...
 * Here you need to obtain the Dependency model element from the ReconnectRequest,
 * create a new DependencyReconnectCommand, set the new connection <i>source</i> by calling
 * the <tt>setNewSource(DependencyFile)</tt> method and return the command instance.
 * <li>Override the <tt>getReconnectTargetCommand(...)</tt> method.</li>
 * Here again you need to obtain the Dependency model element from the ReconnectRequest,
 * create a new DependencyReconnectCommand, set the new connection <i>target</i> by calling
 * the <tt>setNewTarget(DependencyFile)</tt> method and return the command instance.</li>
 * </ol>
 ...
 * @see #setNewSource(DependencyFile)
 * @see #setNewTarget(DependencyFile)
 * @author Elias Volanakis
 */
public class DependencyReconnectCommand extends Command {

/** The connection instance to reconnect. */
private Dependency connection;
/** The new source endpoint. */
private DependencyFile newSource;
/** The new target endpoint. */
private DependencyFile newTarget;
/** The original source endpoint. */
private final DependencyFile oldSource;
/** The original target endpoint. */
private final DependencyFile oldTarget;

/**
 * Instantiate a command that can reconnect a Dependency instance to a different source
 * or target endpoint.
 * @param conn the connection instance to reconnect (non-null)
 * @throws IllegalArgumentException if conn is null
 */
public DependencyReconnectCommand(Dependency conn) {
	if (conn == null) {
 ...
 * to the supplied DependencyFile instance.
 * <p>
 ...
 * endpoint.
 * </p>
 * @param connectionSource a non-null DependencyFile instance, to be used as a new source endpoint
 * @throws IllegalArgumentException if connectionSource is null
 */
public void setNewSource(DependencyFile connectionSource) {
 ...
 * endpoint.
 * </p>
 * @param connectionTarget a non-null DependencyFile instance, to be used as a new target endpoint
 * @throws IllegalArgumentException if connectionTarget is null
 */
public void setNewTarget(DependencyFile connectionTarget) {
