 ...
 * 
 * @see dk.diku.emerald.dependencies.model.EmeraldDependencyFile
 * @see dk.diku.emerald.dependencies.model.EllipticalShape
 * @author Elias Volanakis
 */
public abstract class DependencyFile extends ModelElement {
	...
	public static final String LOCATION_PROP = "DependencyFile.Location";

	private static final long serialVersionUID = 1;

	/** Property ID to use then the size of this shape is modified. */
	public static final String SIZE_PROP = "DependencyFile.Size";

	/** Property ID to use when the list of outgoing connections is modified. */
	public static final String SOURCE_CONNECTIONS_PROP = "DependencyFile.SourceConn";

	/** Property ID to use when the list of incoming connections is modified. */
	public static final String TARGET_CONNECTIONS_PROP = "DependencyFile.TargetConn";

	/**
	 * ID for the X property value (used for by the corresponding property
	 * descriptor).
	 */
	private static final String XPOS_PROP = "DependencyFile.xPos";

	/**
	 * ID for the Y property value (used for by the corresponding property
	 * descriptor).
	 */
	private static final String YPOS_PROP = "DependencyFile.yPos";
	...
	protected static Image createImage(String name) {
		InputStream stream = DependencyFilesPlugin.class.getResourceAsStream(name);
	 ...
	 */
	void addConnection(Dependency conn) {
	 ...
	 */
	void removeConnection(Dependency conn) {
		if (conn == null) {
			throw new IllegalArgumentException();
		}
		if (conn.getSource() == this) {
