...
/**
 * Provides context menu actions for the DependencyFilesEditor.
 * @author Elias Volanakis
 */
class DependencyFilesEditorContextMenuProvider extends ContextMenuProvider {
 ...
 */
public DependencyFilesEditorContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
	super(viewer);
	if (registry == null) {
