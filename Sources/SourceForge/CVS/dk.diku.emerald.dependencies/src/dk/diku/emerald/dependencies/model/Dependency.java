...
/** 
 * Used for indicating that a Dependency with solid line style should be created.
 * @see dk.diku.emerald.dependencies.parts.DependencyFileEditPart#createEditPolicies() 
 */
...
/** Dependency's source endpoint. */
private DependencyFile source;
/** Dependency's target endpoint. */
 ...
 */
public Dependency(DependencyFile source, DependencyFile target) {
 ...
 * @return a non-null DependencyFile instance
 */
public DependencyFile getSource() {
	return source;
}
 ...
 * @return a non-null DependencyFile instance
 */
public DependencyFile getTarget() {
	return target;
}
 ...
 */
public void reconnect(DependencyFile newSource, DependencyFile newTarget) {
