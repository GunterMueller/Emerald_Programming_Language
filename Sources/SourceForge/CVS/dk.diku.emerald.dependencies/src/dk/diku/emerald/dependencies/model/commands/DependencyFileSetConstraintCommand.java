 ...
 */
public class DependencyFileSetConstraintCommand extends Command {
...
/** DependencyFile to manipulate. */
private final DependencyFile shape;
 ...
 */
public DependencyFileSetConstraintCommand(DependencyFile shape, ChangeBoundsRequest req, 
		Rectangle newBounds) {
 ...
 */
public void execute() {
	oldBounds = new Rectangle(shape.getLocation(),new Dimension());
	redo();
}
